            ...
            <form className="space-y-4 md:space-y-6" action="#">
              <div>
                <input
                  ...
                  name="email"
                  id="email"
                  className="bg-white mb-10 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#F9CD46] focus:border-[#F9CD46] block w-full px-3 py-4 placeholder:text-2xl placeholder:text-gray-300"
                  placeholder="Логин"
                  required=""
                />
              </div>
              <div>
                <input
                  ...
                  id="password"
                  placeholder="Пароль"
                  className="bg-white border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#F9CD46] focus:border-[#F9CD46] block w-full px-3 py-4 placeholder:text-2xl placeholder:text-gray-300"
                  required=""
                />
              </div>
